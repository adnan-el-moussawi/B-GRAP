...
public class BGRAP_EdgeValue implements Writable {
	private short partition = -1;
	private byte weight = 1;
	private boolean virtualEdge=true;

	public BGRAP_EdgeValue() {
	}

	public BGRAP_EdgeValue(BGRAP_EdgeValue o) {
		this(o.getPartition(), o.getWeight(), o.isVirtualEdge());
	}

	public BGRAP_EdgeValue(short partition, byte weight) {
		setPartition(partition);
		setWeight(weight);
	}

	public BGRAP_EdgeValue(short partition, byte weight, boolean virtualEdge) {
		setPartition(partition);
		setWeight(weight);
	...
	public boolean equals(Object o) {
		...
		BGRAP_EdgeValue that = (BGRAP_EdgeValue) o;
