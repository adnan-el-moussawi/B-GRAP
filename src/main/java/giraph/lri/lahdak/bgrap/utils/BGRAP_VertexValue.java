...
public class BGRAP_VertexValue implements Writable {
	...
	public BGRAP_VertexValue() {
	}

	public BGRAP_VertexValue(short currentPartition, short newPartition) {
	...
	public boolean equals(Object o) {
		...
		BGRAP_VertexValue that = (BGRAP_VertexValue) o;
