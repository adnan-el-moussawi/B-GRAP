...
public class BGRAP_PartitionMessage implements Writable {
	private long sourceId;
	private short partition;

	public BGRAP_PartitionMessage() {
	}

	public BGRAP_PartitionMessage(long sourceId, short partition) {
	...
	public boolean equals(Object o) {
		...
		BGRAP_PartitionMessage that = (BGRAP_PartitionMessage) o;
