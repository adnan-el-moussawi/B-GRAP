...
public class Spinner extends BGRAP_Partitionning {
	...
	*/
	...
	public static class PartitionerMasterCompute extends SuperPartitionerMasterCompute {
		...
		public void initialize() throws InstantiationException, IllegalAccessException {
			...
			super.setupBGRAPInitializationClass();
			super.setupBGRAPCoreClasses();
		...
		protected void saveTimersStats(boolean isSpinner, long totalMigrations) {
			...
			if (isSaveStatsIntoFile) {
				try {
					String graphname = getContext().getConfiguration().get(GRAPH_NAME_HANDLE, GRAPH_NAME) + DELIMITER;
					
					String filename = getContext().getConfiguration().get(SAVE_PATH, DEFAULT_SAVE_PATH)
							+ "/" +graphname+ "TimeComparison.csv";
