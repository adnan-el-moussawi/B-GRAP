...
public class BGRAP_IntWritable implements WritableComparable {
	public static final String DELIMITER = "_";
	private short partition=-1;
	private int id;

	public BGRAP_IntWritable() {
	}
	
	public BGRAP_IntWritable(int id) {
		setId(id);
	}
	
	public BGRAP_IntWritable(BGRAP_IntWritable o) {
		setId(o.getId());
		setPartition(o.getPartition());
	}
	
	public BGRAP_IntWritable(int id, short partition) {
		setId(id);
		setPartition(partition);
	}
	
	public BGRAP_IntWritable(String id) {
		String[] tokens = id.split(DELIMITER);
		setId(Integer.parseInt(tokens[0]));
		if(tokens.length>1) setPartition(Short.parseShort(tokens[1]));
	}
	
	public BGRAP_IntWritable(String id, String partition) {
	...
	public boolean equals(Object o) {
		...
		BGRAP_IntWritable other = (BGRAP_IntWritable) o;
