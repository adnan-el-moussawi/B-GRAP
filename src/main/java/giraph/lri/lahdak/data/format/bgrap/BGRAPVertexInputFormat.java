...
TextVertexInputFormat<LongWritable, BGRAP_VertexValue, BGRAP_EdgeValue> {
	...
	public class LongLongNullVertexReader extends 
		...
		@Override
	    protected Iterable<Edge<LongWritable, BGRAP_EdgeValue>> getEdges(
	        String[] tokens) throws IOException {
	      List<Edge<LongWritable, BGRAP_EdgeValue>> edges =
