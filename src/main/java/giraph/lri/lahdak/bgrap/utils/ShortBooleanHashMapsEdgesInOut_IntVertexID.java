...
public class ShortBooleanHashMapsEdgesInOut_IntVertexID extends
		ConfigurableOutEdges<IntWritable, BGRAP_EdgeValue> implements
		StrictRandomAccessOutEdges<IntWritable, BGRAP_EdgeValue> {
	...
	@Override
	public void initialize(Iterable<Edge<IntWritable, BGRAP_EdgeValue>> edges) {
	...
	@Override
	public void add(Edge<IntWritable, BGRAP_EdgeValue> edge) {		
	...
	@Override
	public Iterator<Edge<IntWritable, BGRAP_EdgeValue>> iterator() {
		return (Iterator) mutableIterator();
	}
	

	public Iterator<MutableEdge<IntWritable, BGRAP_EdgeValue>> mutableIterator() {
		return new Iterator<MutableEdge<IntWritable, BGRAP_EdgeValue>>() {
			...
			private MutableEdge<IntWritable, BGRAP_EdgeValue> repEdge = EdgeFactory
					.createReusable(new IntWritable(), new BGRAP_EdgeValue());
			...
			@Override
			public MutableEdge<IntWritable, BGRAP_EdgeValue> next() {
	...
	@Override
	public BGRAP_EdgeValue getEdgeValue(IntWritable targetVertexId) {
	...
	@Override
	public void setEdgeValue(IntWritable targetVertexId, BGRAP_EdgeValue edgeValue) {
