...
public class BGRAP_SamplingMessage implements Writable {
	...
	public BGRAP_SamplingMessage() {
		this.sourceId = -1;
		this.partition = -1;
		this.friendlist = new ArrayList<IntWritable>();
	}

	public BGRAP_SamplingMessage(int sourceId, int partition) {
		this.sourceId = sourceId;
		this.partition = partition;
		this.friendlist = new ArrayList<IntWritable>();
	}

	public BGRAP_SamplingMessage(int sourceId, int numfriends, ArrayList<IntWritable> friendlist) {
		this.sourceId = sourceId;
	...
	public boolean equals(Object o) {
		...
		BGRAP_SamplingMessage that = (BGRAP_SamplingMessage) o;
