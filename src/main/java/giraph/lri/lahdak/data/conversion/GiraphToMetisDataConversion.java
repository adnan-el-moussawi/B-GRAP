package giraph.lri.lahdak.data.conversion;
...
import giraph.lri.lahdak.data.format.VertexNeighboorListOutputFormat;
import conf.cikm.GiraphClusterConfiguration;
 ...
 *
 */
public class GiraphToMetisDataConversion extends GiraphClusterConfiguration {
...
//			"Twitter"
	...
	protected GiraphConfiguration VertexDataTest(String filename) throws IOException {
		...
		giraphConf.setMasterComputeClass(BGRAP_Partitionning.SuperPartitionerMasterCompute.class);
		giraphConf.setComputationClass(BGRAP_Partitionning.ConverterPropagate.class);
		...
		giraphConf.setInt(BGRAP_Partitionning.MAX_ITERATIONS_LP, 0);
