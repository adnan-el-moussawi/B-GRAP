...
public class SpinnerVertexValueOutputFormat extends TextVertexOutputFormat<LongWritable, BGRAP_VertexValue, BGRAP_EdgeValue> {
	...
	protected class SpinnerVertexValueWriter extends TextVertexWriterToEachLine {
		...
		@Override
		protected Text convertVertexToLine(Vertex<LongWritable, BGRAP_VertexValue, BGRAP_EdgeValue> vertex) throws IOException {
